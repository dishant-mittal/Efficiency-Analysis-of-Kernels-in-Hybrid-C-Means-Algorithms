...
int main(void)
{
 ...
 //FILE READING COMPLETE
    ...
    int c_approx[2][5][600];
    double c_means[60][5],distance[600][5],c_distance[5][5],U[600][5],diff[600],x_bar[600],addition=0.0,sig_square,dist=0.0;
    int temp;
 ...
 //generated random means                     
  ...
  //initialized distance matrix with 0 
   ...
   sig_square=dist/600.0;
          
  
  for(index=5;index<600;index++)
  {       
          printf("\n\nFOR POINT=%d\n",index+1);
          for(int j=0;j<5;j++)
          {
          ...
          printf("\nmin1 is %d",min1);
          printf("\nmin2 is %d",min2);
          if((distance[index][min2]-distance[index][min1])<0.000001)
          {
                  int flag=0;
                  ...
                  {       
                          ...
                          while((c_approx[0][min1][++count1])!=-1 && count1<600)  //lower
                          sum1+=data[c_approx[0][min1][count1]][p];
                          
                          while(c_approx[1][min1][++count2]!=-1 && count2<600)   //upper
                          {
                  ...
                  {       
                          ...
                          sum2=0.0;
                          sum2a=0.0;
                          while(c_approx[0][min2][++count1]!=-1 && count1<600)
                          sum1+=data[c_approx[0][min2][count1]][p];
                          
                          while(c_approx[1][min2][++count2]!=-1 && count2<600)
                          {     
          ...
          else
          {
                  ...
                  {       
                          ...
                          sum2=0.0;
                          sum2a=0.0;
                          while(c_approx[0][min1][++count1]!=-1 && count1<600)
                          sum1+=data[c_approx[0][min1][count1]][p];
                          
                          while(c_approx[1][min1][++count2]!=-1 && count2<600)
                          {
  ...
  */
  ...
  for(int i=0;i<5;i++)
  {
          ...
          while(c_approx[0][i][++count1]!=-1 && count1<600)
          sum1+=pow(distance[c_approx[0][i][count1]][i],2);
                          
          while(c_approx[1][i][++count2]!=-1 && count2<600)
          {
