...
int main(void)
{
 ...
 //FILE READING COMPLETE
    ...
    double c_means[60][5],distance[600][5],c_distance[5][5],U[600][5],diff[600];
    int temp;
 ...
 //generated random means                     
  ...
  {       
          ...
          printf("\nmax1 is %d",max1);
          printf("\nmax2 is %d",max2);
          if((U[index][max1]-U[index][max2])<0.03)
          {
                  int flag=0;
                  ...
                  {       
                          ...
                          while((c_approx[0][max1][++count1])!=-1 && count1<600)  //lower
                          sum1+=data[c_approx[0][max1][count1]][p];
                          
                          while(c_approx[1][max1][++count2]!=-1 && count2<600)   //upper
                          {
                  ...
                  {       
                          ...
                          sum2=0.0;
                          sum2a=0.0;
                          while(c_approx[0][max2][++count1]!=-1 && count1<600)
                          sum1+=data[c_approx[0][max2][count1]][p];
                          
                          while(c_approx[1][max2][++count2]!=-1 && count2<600)
                          {     
          ...
          else
          {
                  ...
                  {       
                          ...
                          sum2=0.0;
                          sum2a=0.0;
                          while(c_approx[0][max1][++count1]!=-1 && count1<600)
                          sum1+=data[c_approx[0][max1][count1]][p];
                          
                          while(c_approx[1][max1][++count2]!=-1 && count2<600)
                          {
