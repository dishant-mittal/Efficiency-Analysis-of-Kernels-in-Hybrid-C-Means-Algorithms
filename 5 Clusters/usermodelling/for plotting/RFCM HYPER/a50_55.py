...
for i in C1:
    x.append(dt[i,50].astype(np.float))
    y.append(dt[i,55].astype(np.float))
...
for i in C2:
    X1.append(dt[i,50].astype(np.float))
    Y1.append(dt[i,55].astype(np.float))
...
for i in C3:
    X2.append(dt[i,50].astype(np.float))
    Y2.append(dt[i,55].astype(np.float))
...
plt.grid(True)
plt.xlabel('Attribute 51',size='17')
plt.ylabel('Attribute 56',size='17')
