...
int main(void)
{
 ...
 //FILE READING COMPLETE
    ...
    double c_means[60][4],distance[600][4],c_distance[4][4],U[600][4],diff[600],x_bar[600],addition=0.0,sig_square,dist=0.0;
    int temp;
 ...
 //generated random means                     
  ...
  {       
          ...
          printf("\nmin1 is %d",min1);
          printf("\nmin2 is %d",min2);
          if((distance[index][min2]-distance[index][min1])<0.0000003)
          {
                  int flag=0;
