...
/*
  ...
  */
  ...
  FILE *fd = fopen("C:\\Users\\dishant\\Desktop\\coordinates.csv", "w+");
  if(fd == NULL)
  {
 ...
 /* for(int i=0;i<376;i++)
  ...
  //for(int i=0;i<4;i++)
  //printf("\nS value is %lf",S[i]);
  //CALCULATION OF DB INDEX STARTS
  for(int i=0;i<4;i++)
  {
          for(int j=0;j<4;j++)
          {
   ...
   //CALCULATION OF DB INDEX ENDS
   //CALCULATION OF D INDEX STARTS
   int f=0;
