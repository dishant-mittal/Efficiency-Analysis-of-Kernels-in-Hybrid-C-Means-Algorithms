...
int main(void)
{
 ...
 //FILE READING COMPLETE
    ...
    int c_approx[2][4][258];
    double c_means[5][4],distance[258][4],c_distance[4][4],U[258][4],diff[258],x_bar[258],addition=0.0,sig_square,dist=0.0;
    int temp;
 ...
 //generated random means                     
  ...
  {       
          ...
          for(int j=0;j<4;j++)
          {
                  ...
                  distance[index][j]=exp((-1.0*distance[index][j])/(2*sig_square));
          ...
          printf("\nmin1 is %d",min1);
          printf("\nmin2 is %d",min2);
          if((distance[index][min2]-distance[index][min1])<0.007)
          {
                  int flag=0;
                  ...
                  {       
                          ...
                          while((c_approx[0][min1][++count1])!=-1 && count1<258)  //lower
                          sum1+=data[c_approx[0][min1][count1]][p];
                          
                          while(c_approx[1][min1][++count2]!=-1 && count2<258)   //upper
                          {
                          
                          sum2+=(data[c_approx[1][min1][count2]][p]);
                  ...
                  {       
                          ...
                          sum2=0.0;
                          sum2a=0.0;
                          while(c_approx[0][min2][++count1]!=-1 && count1<258)
                          sum1+=data[c_approx[0][min2][count1]][p];
                          
                          while(c_approx[1][min2][++count2]!=-1 && count2<258)
                          {     
                                //printf("index of element is %d\n",c_approx[1][max2][count2]);
                                sum2=sum2+(data[c_approx[1][min2][count2]][p]);
          ...
          else
          {
                  ...
                  {       
                          ...
                          sum2=0.0;
                          sum2a=0.0;
                          while(c_approx[0][min1][++count1]!=-1 && count1<258)
                          sum1+=data[c_approx[0][min1][count1]][p];
                          
                          while(c_approx[1][min1][++count2]!=-1 && count2<258)
                          {
  ...
  FILE *fs = fopen("C:\\Users\\dishant\\Desktop\\coordinates.csv", "w+");
  if(fs == NULL)
  {
        printf("Couldn't open file\n");
        return -1;    
  }
  FILE *fd = fopen("C:\\Users\\dishant\\Desktop\\cluster_datapoints.csv", "w+");
  if(fd == NULL)
  {
        printf("Couldn't open file\n");
        return -1;    
